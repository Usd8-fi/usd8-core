...
/// @notice Deploys, configures, and seeds a Morpho Vault V2 USD8 savings vault once.
/// @dev Seed shares are irrecoverable only when `seedSink` is an irrecoverable address.
